    ...
    <div class="row">
        ...
        <form method="post" class="form-vertical" id="registrar-form" enctype="multipart/form-data">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="id_nombre" type="text" class="" name="nombre"  value="{{Input::old('nombre')}}" required/>
                </div>
            </div>   
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="id_descripcion" type="text" class="" name="descripcion" value="{{Input::old('descripcion')}}" required/>
                </div>
            </div> 
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    ),Input::old('tipoPromocion'),array('required'=>''));}}
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="fechaVencimiento" type="text" class="" value="{{Input::old('fechaVencimiento')}}" name="fechaVencimiento" required/>
                </div>
            </div>
